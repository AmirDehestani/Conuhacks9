                ...
                <div>
                    ...
                    <div className='cherrybomb text-white flex flex-col gap-2 '>
                        ...
                        <div className='flex flex-col gap-1'>
                            ...
                            <input className='bg-[rgba(255,255,255,0)] border-2 border-white rounded-[3px] text-center w-[250px] text-[35px]' type="text" value={Code}/>
                            
                            
                        </div> 

                        <div className='mt-2'>
                            <button className='cherrybomb text-white bg-[rgba(255,255,255,0.25)] px-5 py-1 rounded-[5px] shadow-md hover:scale-[105%] cursor-pointer ease-in-out duration-300'>Start Game</button>
                        </div>
